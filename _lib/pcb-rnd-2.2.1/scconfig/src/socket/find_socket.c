...
int find_socket_fionbio(const char *name, int logdepth, int fatal)
{
	...
	if (try_socket(logdepth, "libs/socket/ioctl/fionbio", "", test_c, NULL, NULL, 0)) {
...
int find_socket_shutdown(const char *name, int logdepth, int fatal)
{
	...
	if (try_socket(logdepth, "libs/socket/shutdown", "", test_c, NULL, NULL, 0)) {
		report("found\n");
		return 0;
	}
...
int find_socket_sockaddr_in(const char *name, int logdepth, int fatal)
{
	...
	/* Look at some standard places */
	if (try_socket(logdepth, "libs/socket/sockaddr_in", "", test_c, NULL, NULL, 1)) return 0;
	if (try_socket(logdepth, "libs/socket/sockaddr_in", inc_db, test_c, NULL, NULL, 1)) return 0;
	if (try_socket(logdepth, "libs/socket/sockaddr_in", inc_inet, test_c, NULL, NULL, 1)) return 0;
...
int find_socket_lac(const char *name, int logdepth, int fatal)
{
	...
	/* Look at some standard places */
	if (try_socket(logdepth, "libs/socket/lac", inc_linux, test_c, NULL, NULL, 1)) return 0;
...
int find_socket_recvsend(const char *name, int logdepth, int fatal)
{
	...
	/* Look at some standard places */
	if (try_socket(logdepth, "libs/socket/recvsend", inc_linux, test_c, NULL, NULL, 1)) return 0;
